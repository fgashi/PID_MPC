...
class constraints_m(parameters_rm,conf_m):
    def __init__(self):
        ...
        self.lbz_m  = self.bounds_m.eta_min*(self.N-1) + self.bounds_m.u_min * ((self.N-1)) + self.bounds_m.r_min*(self.N)   
        self.ubz_m  = self.bounds_m.eta_max*(self.N-1) + self.bounds_m.u_max * ((self.N-1)) + self.bounds_m.r_max*(self.N)   