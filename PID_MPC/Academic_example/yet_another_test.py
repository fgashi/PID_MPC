...
# bn=tst.set_mpc(an,pv)

K_final=[tst.sys_model.sys_param.Kp,tst.sys_model.sys_param.Ki, tst.sys_model.sys_param.Kd]
np.savetxt('/home/fatos/python_ws/git_files/overleaf_files/Graphics/Academic_example/results_z_r/results_N_'+str(N)+'.txt',total_results, delimiter='  ',header='  y    r  e   x1   x2   u   t   ref' ,comments='')
np.savetxt('/home/fatos/python_ws/git_files/overleaf_files/Graphics/Academic_example/results_z_r/sol_time_N_'+str(N)+'.txt',t_wall_solver, delimiter='  ',header='  t_wall_solver ' ,comments='') 
np.savetxt('/home/fatos/python_ws/git_files/overleaf_files/Graphics/Academic_example/results_z_r/K_params_N_'+str(N)+'.txt',K_final, delimiter='  ',header='  Kp         Ki      Kd ' ,comments='') 
