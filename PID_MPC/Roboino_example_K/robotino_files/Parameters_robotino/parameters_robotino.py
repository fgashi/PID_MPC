...
class boundaries_m:
    def __init__(self):
        self.eta_min =[-15, -15, -15, -3800,  -3800, -3800];
        self.eta_max =[ 15,  15,  15,  3800,   3800,  3800]


        # self.w_min = [ -3200,  -3200, -3200]
        # self.w_max = [  3200,   3200,  3200]

        self.r_min =[ -3800, -3800, -3800,]
        self.r_max =[  3800,  3800,  3800]

        self.K_min= [  0,  0,  0,  0,  0,  0,  0,  0,  0]
        self.K_max= [100,100,100,100,100,100,100,100,100]
